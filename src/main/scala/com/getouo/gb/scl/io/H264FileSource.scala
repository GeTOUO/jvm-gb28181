...
class H264FileSource(h264videoFileName: String, accFileName: Option[String] = None) extends UnActiveSource[H264SourceData] with H264NALUFramer {
...
//    this.lastStartLen = value.nextStartTagLen
//    value.data match {
...
//  }
  ...
  override protected def read(buf: Array[Byte]): Array[Byte] = {
    val sourceData = fisSource.produce()
    sourceData match {
      case ByteSourceData(array) => array
      case _ => Array.empty
    }
  }
}
