...
//
//    val ps: H264PlayStream = H264PlayStream.getOrElseSubmit(FileSourceId("src/main/resources/slamtv60.264", System.currentTimeMillis()), id => {
//      new H264PlayStream(id, new H264FileSource(id.file), new H264ConsumptionPipeline())
//    })
//    val consumer = ps.getOrElseAddConsumer(classOf[H264RtpConsumer], new H264RtpConsumer())
